    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inventory_number', models.ForeignKey(default=1, on_delete=django.db.models.deletion.SET_DEFAULT, to='inventory.inventorynumber', verbose_name='Инвентарный номер')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('inventory_number', models.ForeignKey(blank=True, db_constraint=False, default=1, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='inventory.inventorynumber', verbose_name='Инвентарный номер')),
